...
export const STAFF_GROUPS: StaffGroup[] = [
  ...
  },
  {
    role: 'admin',
    title: 'Co-Líderes',
    description: 'Segunda al mando: apoyan la dirección del clan y supervisan al resto del staff.',
    members: [
      {
        id: 'admin-1',
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        role: 'coordinator',
        rankLabel: 'Administrator',
        blurb: 'Cara digital del clan: web y marketing.',
        photo: '/staff/coordinador-03.webp',
        ...rankIcon('Administrator'),
      },
    ],
  },
